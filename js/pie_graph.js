...
var myChart = new Chart(ctx, {
    type: 'pie',
    data: {
        labels: ['Revok Forest Worst-case', 'Langker Pasture Worst-case', 'Revok Forest Standard', 'Langker Pasture Standard'],
        datasets: [{
...
function updateChart() {
    var value1 = document.getElementById('6. Graph - Revok Forest Worst-case').value || 0;
    var value2 = document.getElementById('6. Graph - Langker Pasture Worst-case').value || 0;
    var value3 = document.getElementById('6. Graph - Revok Forest Standard').value || 0;
    var value4 = document.getElementById('6. Graph - Langker Pasture Standard').value || 0;

    myChart.data.datasets[0].data = [value1, value2, value3, value4];
    myChart.update();
}
// Add input event listeners to all input fields
document.getElementById('6. Graph - Revok Forest Worst-case').addEventListener('input', updateChart);
document.getElementById('6. Graph - Langker Pasture Worst-case').addEventListener('input', updateChart);
